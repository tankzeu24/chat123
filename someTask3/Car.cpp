...
ostream& operator<<(ostream &os, const Car &car)
{
    ...
    os<<"SKU : "<<car.getSKU()<<" ,Count : "<<car.getCount()<<" ,Model : " <<car.getModel()
    <<" ,Brand : "<<car.getBrand()<< " ,Category : "<<car.getCategory()
    <<" ,Price : "<<car.getPrice()<<" ,Miles : "<<car.getMiles()<<endl;
    return os;
}
